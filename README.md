...
If you use Homebrew/MacPorts/apt as your package manager, we provide
convenience scripts for installing faceAnalyzer - you can simply run the
following commands to download and build it.
...
1. When the AU prediction module of the OpenFace 2.0 toolkit was evaluated, it
   ...
   qualified accuracy of OpenFace, the faceAnalyzer executable is expected to
